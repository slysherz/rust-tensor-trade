...
impl Instrument {
    ...
    pub fn msft() -> Instrument {
        Instrument {
            ...
            precision: 2,
            name: "Microsoft stock".to_string(),
        }
    }
